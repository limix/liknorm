...
if %ERRORLEVEL% NEQ 0 (echo FAILED. && type %LOG_FILE% && call :byebye 1) else (echo done.)
...
if %ERRORLEVEL% NEQ 0 (echo FAILED. && type %LOG_FILE% && call :byebye 1)
if NOT exist %programfiles%\liknorm\lib\liknorm.lib (echo FAILED. && type %LOG_FILE% && call :byebye 1)
if NOT exist %programfiles%\liknorm\bin\liknorm.dll (echo FAILED. && type %LOG_FILE% && call :byebye 1)
if NOT exist %programfiles%\liknorm\lib\liknorm_static.lib (echo FAILED. && type %LOG_FILE% && call :byebye 1)
if NOT exist %programfiles%\liknorm\include\liknorm.h (echo FAILED. && type %LOG_FILE% && call :byebye 1) else (echo done.)
