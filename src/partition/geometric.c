...
double geometric_log_partition(const double theta) { return -log1p(-exp(theta)); }
...
void geometric_log_partition_derivatives(const double theta, double *b0, double *logb1,
                                         double *logb2)
{
